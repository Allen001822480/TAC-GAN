...
def linear(input_, output_size, matrix=None, bias=None, scope=None, stddev=0.02, bias_start=0.0,
           with_w=False,):
    shape = input_.get_shape().as_list()
    with tf.variable_scope(scope or "Linear",reuse=tf.AUTO_REUSE) as scope_linear:
